...
main(int argc, char *argv[])
{
  ...
  12:	e8 ca 03 00 00       	call   3e1 <getuid>
  17:	50                   	push   %eax
  18:	ff 33                	pushl  (%ebx)
  1a:	68 58 08 00 00       	push   $0x858
  1f:	6a 01                	push   $0x1
  21:	e8 ca 04 00 00       	call   4f0 <printf>
  exit();
  26:	e8 f6 02 00 00       	call   321 <exit>
  2b:	66 90                	xchg   %ax,%ax
  2d:	66 90                	xchg   %ax,%ax
  2f:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
 ...
 674:	eb 1a                	jmp    690 <printf+0x1a0>
          s = "(null)";
 676:	bb 74 08 00 00       	mov    $0x874,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c1:	a1 5c 0b 00 00       	mov    0xb5c,%eax
{
 ...
 6e6:	73 10                	jae    6f8 <free+0x38>
{
 ...
 711:	5b                   	pop    %ebx
  freep = p;
 712:	a3 5c 0b 00 00       	mov    %eax,0xb5c
}
 717:	5e                   	pop    %esi
 718:	5f                   	pop    %edi
 719:	5d                   	pop    %ebp
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 73a:	a3 5c 0b 00 00       	mov    %eax,0xb5c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 3d 5c 0b 00 00    	mov    0xb5c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7a9:	8b 3d 5c 0b 00 00    	mov    0xb5c,%edi
 ...
 7d2:	e8 e9 fe ff ff       	call   6c0 <free>
  return freep;
 7d7:	8b 15 5c 0b 00 00    	mov    0xb5c,%edx
 ...
 804:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 807:	89 15 5c 0b 00 00    	mov    %edx,0xb5c
}
 ...
 81f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 5c 0b 00 00 60 	movl   $0xb60,0xb5c
 827:	0b 00 00 
    base.s.size = 0;
 82a:	bf 60 0b 00 00       	mov    $0xb60,%edi
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 60 0b 00 00 60 	movl   $0xb60,0xb60
 836:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 839:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 83b:	c7 05 64 0b 00 00 00 	movl   $0x0,0xb64
 842:	00 00 00 
    if(p->s.size >= nunits){
