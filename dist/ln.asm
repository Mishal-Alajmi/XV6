   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	e8 fb 04 00 00       	call   520 <printf>
    exit();
  25:	e8 27 03 00 00       	call   351 <exit>
  }
  ...
  32:	e8 7a 03 00 00       	call   3b1 <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 0e 03 00 00       	call   351 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
...
free(void *ap)
{
 ...
 6f1:	a1 98 0b 00 00       	mov    0xb98,%eax
{
 ...
 716:	73 10                	jae    728 <free+0x38>
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	a3 98 0b 00 00       	mov    %eax,0xb98
}
 747:	5e                   	pop    %esi
 748:	5f                   	pop    %edi
 749:	5d                   	pop    %ebp
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 98 0b 00 00       	mov    %eax,0xb98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 3d 98 0b 00 00    	mov    0xb98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d9:	8b 3d 98 0b 00 00    	mov    0xb98,%edi
 ...
 802:	e8 e9 fe ff ff       	call   6f0 <free>
  return freep;
 807:	8b 15 98 0b 00 00    	mov    0xb98,%edx
 ...
 834:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 837:	89 15 98 0b 00 00    	mov    %edx,0xb98
}
 ...
 84f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 98 0b 00 00 9c 	movl   $0xb9c,0xb98
 857:	0b 00 00 
    base.s.size = 0;
 85a:	bf 9c 0b 00 00       	mov    $0xb9c,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 9c 0b 00 00 9c 	movl   $0xb9c,0xb9c
 866:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 86b:	c7 05 a0 0b 00 00 00 	movl   $0x0,0xba0
 872:	00 00 00 
    if(p->s.size >= nunits){
