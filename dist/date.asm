   ...
   f:	8d 45 d0             	lea    -0x30(%ebp),%eax
{
  ...
  if (date(&r)) {
  17:	50                   	push   %eax
  18:	e8 fc 04 00 00       	call   519 <date>
  1d:	83 c4 10             	add    $0x10,%esp
  20:	85 c0                	test   %eax,%eax
  22:	0f 85 39 01 00 00    	jne    161 <main+0x161>
  ...
  28:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
  2b:	8b 4d e0             	mov    -0x20(%ebp),%ecx
  2e:	8b 75 dc             	mov    -0x24(%ebp),%esi
  return (d+=m<3?y--:y-2,23*m/9+d+4+y/4-y/100+y/400)%7;
  31:	8d 7b fe             	lea    -0x2(%ebx),%edi
  34:	83 f9 02             	cmp    $0x2,%ecx
  ...
  return (d+=m<3?y--:y-2,23*m/9+d+4+y/4-y/100+y/400)%7;
  41:	ba 39 8e e3 38       	mov    $0x38e38e39,%edx
  printf(1, "%s %s %d", days[day], months[r.month], r.day);
  46:	56                   	push   %esi
  return (d+=m<3?y--:y-2,23*m/9+d+4+y/4-y/100+y/400)%7;
  47:	01 fe                	add    %edi,%esi
  printf(1, "%s %s %d", days[day], months[r.month], r.day);
  49:	ff 34 8d 80 0a 00 00 	pushl  0xa80(,%ecx,4)
  return (d+=m<3?y--:y-2,23*m/9+d+4+y/4-y/100+y/400)%7;
  50:	6b c9 17             	imul   $0x17,%ecx,%ecx
  53:	89 c8                	mov    %ecx,%eax
  55:	c1 f9 1f             	sar    $0x1f,%ecx
  58:	f7 ea                	imul   %edx
  5a:	d1 fa                	sar    %edx
  5c:	29 ca                	sub    %ecx,%edx
  5e:	85 db                	test   %ebx,%ebx
  60:	8d 4b 03             	lea    0x3(%ebx),%ecx
  63:	0f 49 cb             	cmovns %ebx,%ecx
  66:	8d 44 32 04          	lea    0x4(%edx,%esi,1),%eax
  6a:	ba 1f 85 eb 51       	mov    $0x51eb851f,%edx
  6f:	c1 f9 02             	sar    $0x2,%ecx
  72:	01 c1                	add    %eax,%ecx
  74:	89 d8                	mov    %ebx,%eax
  76:	c1 fb 1f             	sar    $0x1f,%ebx
  79:	f7 ea                	imul   %edx
  7b:	89 df                	mov    %ebx,%edi
  7d:	89 d0                	mov    %edx,%eax
  7f:	c1 fa 07             	sar    $0x7,%edx
  82:	c1 f8 05             	sar    $0x5,%eax
  85:	29 da                	sub    %ebx,%edx
  87:	29 c7                	sub    %eax,%edi
  89:	01 f9                	add    %edi,%ecx
  8b:	01 d1                	add    %edx,%ecx
  8d:	ba 93 24 49 92       	mov    $0x92492493,%edx
  92:	89 c8                	mov    %ecx,%eax
  94:	f7 ea                	imul   %edx
  96:	89 c8                	mov    %ecx,%eax
  98:	c1 f8 1f             	sar    $0x1f,%eax
  9b:	01 ca                	add    %ecx,%edx
  9d:	c1 fa 02             	sar    $0x2,%edx
  a0:	29 c2                	sub    %eax,%edx
  a2:	8d 04 d5 00 00 00 00 	lea    0x0(,%edx,8),%eax
  a9:	29 d0                	sub    %edx,%eax
  ab:	29 c1                	sub    %eax,%ecx
  printf(1, "%s %s %d", days[day], months[r.month], r.day);
  ad:	ff 34 8d 60 0a 00 00 	pushl  0xa60(,%ecx,4)
  b4:	68 c7 09 00 00       	push   $0x9c7
  b9:	6a 01                	push   $0x1
  bb:	e8 80 05 00 00       	call   640 <printf>
  printf(1, " ");
  c0:	83 c4 18             	add    $0x18,%esp
  c3:	68 d0 09 00 00       	push   $0x9d0
  c8:	6a 01                	push   $0x1
  ca:	e8 71 05 00 00       	call   640 <printf>
  if (r.hour < 10) printf(1, "0");
  cf:	83 c4 10             	add    $0x10,%esp
  d2:	83 7d d8 09          	cmpl   $0x9,-0x28(%ebp)
  d6:	76 73                	jbe    14b <main+0x14b>
  printf(1, "%d:", r.hour);
  d8:	83 ec 04             	sub    $0x4,%esp
  db:	ff 75 d8             	pushl  -0x28(%ebp)
  de:	68 d4 09 00 00       	push   $0x9d4
  e3:	6a 01                	push   $0x1
  e5:	e8 56 05 00 00       	call   640 <printf>
  if (r.minute < 10) printf(1, "0");
  ea:	83 c4 10             	add    $0x10,%esp
  ed:	83 7d d4 09          	cmpl   $0x9,-0x2c(%ebp)
  f1:	76 45                	jbe    138 <main+0x138>
  printf(1, "%d:", r.minute);
  f3:	83 ec 04             	sub    $0x4,%esp
  f6:	ff 75 d4             	pushl  -0x2c(%ebp)
  f9:	68 d4 09 00 00       	push   $0x9d4
  fe:	6a 01                	push   $0x1
 100:	e8 3b 05 00 00       	call   640 <printf>
  if (r.second < 10) printf(1, "0");
 105:	83 c4 10             	add    $0x10,%esp
 108:	83 7d d0 09          	cmpl   $0x9,-0x30(%ebp)
 10c:	76 17                	jbe    125 <main+0x125>
  printf(1, "%d UTC %d\n", r.second, r.year);
 10e:	ff 75 e4             	pushl  -0x1c(%ebp)
 111:	ff 75 d0             	pushl  -0x30(%ebp)
 114:	68 d8 09 00 00       	push   $0x9d8
 119:	6a 01                	push   $0x1
 11b:	e8 20 05 00 00       	call   640 <printf>

  exit();
 120:	e8 4c 03 00 00       	call   471 <exit>
  if (r.second < 10) printf(1, "0");
 125:	50                   	push   %eax
 126:	50                   	push   %eax
 127:	68 d2 09 00 00       	push   $0x9d2
 12c:	6a 01                	push   $0x1
 12e:	e8 0d 05 00 00       	call   640 <printf>
 133:	83 c4 10             	add    $0x10,%esp
 136:	eb d6                	jmp    10e <main+0x10e>
  if (r.minute < 10) printf(1, "0");
 138:	52                   	push   %edx
 139:	52                   	push   %edx
 13a:	68 d2 09 00 00       	push   $0x9d2
 13f:	6a 01                	push   $0x1
 141:	e8 fa 04 00 00       	call   640 <printf>
 146:	83 c4 10             	add    $0x10,%esp
 149:	eb a8                	jmp    f3 <main+0xf3>
  if (r.hour < 10) printf(1, "0");
 14b:	51                   	push   %ecx
 14c:	51                   	push   %ecx
 14d:	68 d2 09 00 00       	push   $0x9d2
 152:	6a 01                	push   $0x1
 154:	e8 e7 04 00 00       	call   640 <printf>
 159:	83 c4 10             	add    $0x10,%esp
 15c:	e9 77 ff ff ff       	jmp    d8 <main+0xd8>
    printf(2,"Error: date call failed. %s at line %d\n",
 161:	6a 1c                	push   $0x1c
 163:	68 c0 09 00 00       	push   $0x9c0
 168:	68 34 0a 00 00       	push   $0xa34
 16d:	6a 02                	push   $0x2
 ...
 586:	89 d3                	mov    %edx,%ebx
{
 ...
 5c9:	0f b6 92 bc 0a 00 00 	movzbl 0xabc(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 7c4:	eb 1a                	jmp    7e0 <printf+0x1a0>
          s = "(null)";
 7c6:	bb b4 0a 00 00       	mov    $0xab4,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 811:	a1 a4 0d 00 00       	mov    0xda4,%eax
{
 ...
 836:	73 10                	jae    848 <free+0x38>
{
 ...
 861:	5b                   	pop    %ebx
  freep = p;
 862:	a3 a4 0d 00 00       	mov    %eax,0xda4
}
 867:	5e                   	pop    %esi
 868:	5f                   	pop    %edi
 869:	5d                   	pop    %ebp
 ...
 887:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 88a:	a3 a4 0d 00 00       	mov    %eax,0xda4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 8a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 8ac:	8b 3d a4 0d 00 00    	mov    0xda4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8f9:	8b 3d a4 0d 00 00    	mov    0xda4,%edi
 ...
 922:	e8 e9 fe ff ff       	call   810 <free>
  return freep;
 927:	8b 15 a4 0d 00 00    	mov    0xda4,%edx
 ...
 954:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 957:	89 15 a4 0d 00 00    	mov    %edx,0xda4
}
 ...
 96f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 970:	c7 05 a4 0d 00 00 a8 	movl   $0xda8,0xda4
 977:	0d 00 00 
    base.s.size = 0;
 97a:	bf a8 0d 00 00       	mov    $0xda8,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 989:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 98b:	c7 05 ac 0d 00 00 00 	movl   $0x0,0xdac
 992:	00 00 00 
    if(p->s.size >= nunits){
