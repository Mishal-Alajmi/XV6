...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 87 03 00 00       	call   3c1 <unlink>
...
printf(int fd, char *fmt, ...)
{
 ...
 6c4:	eb 1a                	jmp    6e0 <printf+0x1a0>
          s = "(null)";
 6c6:	bb d5 08 00 00       	mov    $0x8d5,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 711:	a1 c8 0b 00 00       	mov    0xbc8,%eax
{
 ...
 736:	73 10                	jae    748 <free+0x38>
{
 ...
 761:	5b                   	pop    %ebx
  freep = p;
 762:	a3 c8 0b 00 00       	mov    %eax,0xbc8
}
 767:	5e                   	pop    %esi
 768:	5f                   	pop    %edi
 769:	5d                   	pop    %ebp
 ...
 787:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 78a:	a3 c8 0b 00 00       	mov    %eax,0xbc8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 3d c8 0b 00 00    	mov    0xbc8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7f9:	8b 3d c8 0b 00 00    	mov    0xbc8,%edi
 ...
 822:	e8 e9 fe ff ff       	call   710 <free>
  return freep;
 827:	8b 15 c8 0b 00 00    	mov    0xbc8,%edx
 ...
 854:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 857:	89 15 c8 0b 00 00    	mov    %edx,0xbc8
}
 ...
 86f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 870:	c7 05 c8 0b 00 00 cc 	movl   $0xbcc,0xbc8
 877:	0b 00 00 
    base.s.size = 0;
 87a:	bf cc 0b 00 00       	mov    $0xbcc,%edi
    base.s.ptr = freep = prevp = &base;
 87f:	c7 05 cc 0b 00 00 cc 	movl   $0xbcc,0xbcc
 886:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 889:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 88b:	c7 05 d0 0b 00 00 00 	movl   $0x0,0xbd0
 892:	00 00 00 
    if(p->s.size >= nunits){
